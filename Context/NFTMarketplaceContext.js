...
const projectId = "2NlV4KwnCOU6szrcNWs9MRbTKmH";
const projectSecretKey = "c085784edbfb1f3680861906782ba98e";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://daksh-nft.infura-ipfs.io";
...
export const NFTMarketplaceProvider = ({ children }) => {
  ...
  const createNFT = async (name, price, image, description, router) => {
    ...
    try {
      ...
      const url = `https://daksh-nft.infura-ipfs.io/ipfs/${added.path}`;
